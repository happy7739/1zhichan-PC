<?php /*a:4:{s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\aboutus\index.html";i:1588148002;s:67:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\base.html";i:1589515459;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\header.html";i:1588210734;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\footer.html";i:1589515829;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
                ...
                <td>
                    <div class="lyzhe" >
                        <form method="post" class="form-horizontal" action="<?php echo url('index/Home/insert_message'); ?>" id="homeForm">
                            <div class="ly1">
                                <span>姓名：</span>
                                <input type="text" name="name" id="txtName" value=""><br />
                            </div>
                            <div class="ly1">
                                <span>电话：</span>
                                <input type="text" name="phone" id="txtPhone" value=""><br />
                            </div>
                            <div class="ly1">
                                <span>留言：</span>
                                <textarea name="content" rows="" cols="" id="txtContent"></textarea>
                            </div>
                            <button type="submit" name="" id="tjly" value="" class="b4" onclick="FromSubmit2()">在线申请</button>
                        </form>
                    </div>
                </td>
            </tr>
