                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" id="pid" name="pid">
                                        ...
                                        <option value="<?php echo htmlentities($key); ?>"><?php echo $role; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" id="default_module" name="default_module">
                                        ...
                                        <option value="<?php echo htmlentities($key); ?>"><?php echo $module; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
