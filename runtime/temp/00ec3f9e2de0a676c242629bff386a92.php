                ...
                <td>
                    <div align="left" class="font14" style="line-height: 0px;">
                        <div class="cnr">
                            ...
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            <?php endif; ?>
                            <div style='background: url("<?php echo htmlentities(get_file_path($bg_id)); ?>"); width: 910px; height: 364px;line-height: 27px;'>
                                <ul class="dlzqtable">
                                    <li class="dlzqtablefw">
                                        项目
                                    </li>
                                    <li class="dlzqtablefw">
                                        县（市、地辖区）级代理
