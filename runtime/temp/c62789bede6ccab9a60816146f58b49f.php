<?php /*a:4:{s:66:"F:\Project\DolphinPHPV1.4.5\application\index\view\food\index.html";i:1587966400;s:67:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\base.html";i:1588518184;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\header.html";i:1588210734;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\footer.html";i:1588521994;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
                    ...
                    <div align="left" class="font14" style="line-height: 0px;">
                        <div class="cnr">
                            <div>
                                ...
                                <img src="<?php echo htmlentities(get_file_path($val['img'])); ?>" style="border: none;padding: 0px;margin: 0px;"/>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php endif; ?>
                            </div>
                            <div>
                                ...
                                <div class="jsCusbox">
                                    <div class="jsCus">
                                        <ul>
                                            <?php if(!(empty($data3) || (($data3 instanceof \think\Collection || $data3 instanceof \think\Paginator ) && $data3->isEmpty()))): if(is_array($data3) || $data3 instanceof \think\Collection || $data3 instanceof \think\Paginator): $i = 0; $__LIST__ = $data3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                            <li>
                                                <img src="<?php echo htmlentities(get_file_path($val['img'])); ?>" />
                                            </li>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <div>
                                <?php if(!(empty($data4) || (($data4 instanceof \think\Collection || $data4 instanceof \think\Paginator ) && $data4->isEmpty()))): if(is_array($data4) || $data4 instanceof \think\Collection || $data4 instanceof \think\Paginator): $i = 0; $__LIST__ = $data4;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                <img src="<?php echo htmlentities(get_file_path($val['img'])); ?>" />
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php endif; ?>
                            </div>
