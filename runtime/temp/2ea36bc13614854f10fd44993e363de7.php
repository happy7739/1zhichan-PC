                                ...
                                <div class="wx_tips3 j_tips3" align="center">
                                    <div class="tips_hd3">
                                        <div style="width: 298px; overflow: hidden; height: 214px;">
                                            <a title="<?php echo htmlentities($val['title']); ?>" href="<?php echo url('index/project/details'); ?>?id=<?php echo htmlentities($val['id']); ?>">
                                                <img src="<?php echo htmlentities(get_file_path($val['img'])); ?>" width="298" height="214">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="tips_bd3">
                                        <a href="<?php echo url('index/project/details'); ?>?id=<?php echo htmlentities($val['id']); ?>" title="<?php echo htmlentities($val['title']); ?>"><?php echo htmlentities($val['title']); ?></a>
                                    </div>
                                </div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
