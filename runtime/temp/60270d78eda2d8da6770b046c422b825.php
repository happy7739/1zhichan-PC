<?php /*a:4:{s:66:"F:\Project\DolphinPHPV1.4.5\application\index\view\news\index.html";i:1588045439;s:67:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\base.html";i:1588518184;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\header.html";i:1588210734;s:69:"F:\Project\DolphinPHPV1.4.5\application\index\view\public\footer.html";i:1588521994;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
                    ...
                    <div align="left" class="font14" style="line-height: 0px;">
                        <div class="a1" align="center">
                            ...
                            <?php if(!(empty($data) || (($data instanceof \think\Collection || $data instanceof \think\Paginator ) && $data->isEmpty()))): if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?>
                                <table width="930" border="0" cellpadding="0" cellspacing="0" align="center"> <tbody><tr><td height="30"></td></tr></tbody></table>
                                <table width="930" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#efefef">
                                    <tbody>
                                    <tr>
                                        <td width="202" align="left">
                                            <a href="<?php echo url('index/news/details'); ?>?cat=<?php echo htmlentities($cat); ?>&page=<?php echo htmlentities($page); ?>&id=<?php echo htmlentities($val['id']); ?>" title="<?php echo htmlentities($val['title']); ?>">
                                                <img src="<?php echo htmlentities(get_file_path($val['img'])); ?>" width="202" height="126">
                                            </a>
                                        </td>
                                        <td width="30"></td>
                                        <td width="659" align="left" valign="top">
                                            <div style="position: absolute; padding-top: 18px; width: 659px;">
                                                <span class="font16">
                                                    <a href="<?php echo url('index/news/details'); ?>?cat=<?php echo htmlentities($cat); ?>&page=<?php echo htmlentities($page); ?>&id=<?php echo htmlentities($val['id']); ?>" title="<?php echo htmlentities($val['title']); ?>"><b><?php echo htmlentities($val['title']); ?></b></a>
                                                </span>
                                                <div class="font14" style="line-height: 28px; padding-top: 18px;">
                                                    <?php echo htmlentities($val['desc']); ?>
                                                </div>
                                                <div style="position: absolute; top: 18px; right: 0;" class="font14"><?php echo htmlentities($val['time']); ?></div>
                                            </div>
                                        </td>
                                        <td width="39"></td>
                                    </tr>
...
<script>
    function FromSubmit2() {
        $("#tjly").attr("disabled", "disabled");
        var name = $("#txtName").val();
        var phone = $("#Phone").val();
        var content = $("#txtContent").val();
        if (phone.length == 0) {
            alert("请填写必填信息");
            $("#tjly").removeAttr("disabled");
            return false;
        }
        ...
        $.ajax({
            url:"<?php echo url('index/Home/insert_message'); ?>",
            type:"POST",
            data:{
                name:name,
                phone:phone,
