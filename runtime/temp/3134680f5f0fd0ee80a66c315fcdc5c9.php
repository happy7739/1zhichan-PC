...
<link href="/static/libs/jstree/themes/default/style.min.css" rel="stylesheet" />
                    ...
                    <div class="block-content tab-content">
                        <div class="tab-pane fade in active push-20" id="tab1">
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" id="pid" name="pid">
                                        ...
                                        <option value="<?php echo htmlentities($key); ?>" <?php if($info['pid'] == $key): ?>selected<?php endif; ?>><?php echo $role; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="title" name="name" value="<?php echo htmlentities($info['name']); ?>" placeholder="请输入角色名称">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-xs-12" for="description">角色描述</label>
                                <div class="col-xs-12">
                                    <textarea class="form-control" id="description" rows="7" name="description" placeholder="请输入角色描述"><?php echo htmlentities($info['description']); ?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <select class="form-control" id="default_module" name="default_module">
                                        ...
                                        <option value="<?php echo htmlentities($key); ?>" <?php if($info['default_module'] == $key): ?>selected<?php endif; ?>><?php echo $module; ?></option>
                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                        <input type="radio" name="access" id="access1" value="0" <?php if($info['access'] == '0'): ?>checked<?php endif; ?>>
                                        <span></span> 否</label>
                                    <label class="css-input css-radio css-radio-primary css-radio-sm push-10-r">
                                        <input type="radio" name="access" id="access2" value="1" <?php if($info['access'] == '1'): ?>checked<?php endif; ?>>
                                        <span></span> 是</label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" id="sort" name="sort" value="<?php echo htmlentities($info['sort']); ?>" placeholder="请输入排序">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane fade auth-node" id="tab2">
                            ...
                            <div class="block">
                                <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs" id="menu-tab">
                                    ...
                                    <li class="<?php if($curr_tab==$key) echo 'active'; ?>">
                                        <a href="#<?php echo htmlentities($key); ?>" data-tab="<?php echo htmlentities($key); ?>"><?php echo htmlentities($vo['title']); ?></a>
                                    </li>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </ul>
                                <div class="block-content tab-content">
                                    <?php if(is_array($menus) || $menus instanceof \think\Collection || $menus instanceof \think\Paginator): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                    <div class="tab-pane <?php if($curr_tab==$key) echo 'active'; ?>" id="<?php echo htmlentities($key); ?>">
                                        <div class="push js-tree" data-tab="<?php echo htmlentities($key); ?>"><?php echo (isset($vo['menus']) && ($vo['menus'] !== '')?$vo['menus']:''); ?></div>
                                    </div>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
...
<script>
    $(document).ready(function(){
        const $tree_list = {};
        const $key_auth  = {};
        let curr_tab     = '<?php echo htmlentities($curr_tab); ?>';
