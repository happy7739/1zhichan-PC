...
class Fooda extends Admin
{
    ...
    public function index()
    {
        ...
        $order = $this->getOrder();
        // 数据列表
        $data_list = FoodsModel::where($map)->whereIn('pag','1,4')->order($order)->paginate();
        //所属分页
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($page = FoodsModel::create($data)) {
                // 记录行为
                action_log('foods_add', 'admin_foods', $page['id'], UID, "添加");
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (FoodsModel::update($data)) {
                // 记录行为
                action_log('foods_edit', 'admin_foods', $id, UID, "编辑");
    ...
    public function setStatus($type = '', $record = [])
    {
        ...
        return parent::setStatus($type, ['page_'.$type, 'admin_foods', 0, UID, implode('、', $page_title)]);
    }
    ...
    public function quickEdit($record = [])
    {
        ...
        return parent::quickEdit(['foods_edit', 'admin_foods', $id, UID, $details]);
    }
}
