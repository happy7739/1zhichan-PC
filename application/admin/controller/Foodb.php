...
class Foodb extends Admin
{
    ...
    public function index()
    {
        ...
        $order = $this->getOrder();
        // 数据列表
        $data_list = FoodsModel::where($map)->whereIn('pag','2')->order($order)->paginate();
        //所属分页
    ...
    public function add()
    {
        ...
        if ($this->request->isPost()) {
            ...
            if ($page = FoodsModel::create($data)) {
                // 记录行为
                action_log('foodb_add', 'admin_foodb', $page['id'], UID, "添加");
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->isPost()) {
            ...
            if (FoodsModel::update($data)) {
                // 记录行为
                action_log('foodb_edit', 'admin_foodb', $id, UID, "编辑");
    ...
    public function setStatus($type = '', $record = [])
    {
        ...
        return parent::setStatus($type, ['page_'.$type, 'admin_foodb', 0, UID, implode('、', $page_title)]);
    }
    ...
    public function quickEdit($record = [])
    {
        ...
        return parent::quickEdit(['foodb_edit', 'admin_foodb', $id, UID, $details]);
    }
}
