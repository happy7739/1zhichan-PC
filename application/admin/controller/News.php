...
class News extends Admin
{
    ...
    public function index()
    {
        ...
        foreach ($data_list as $key => &$value) {
            $nav = Db::table("dp_admin_navigation")->where(['id'=>$value['pid']])->field(['title'])->find();
            $value['pid'] = $nav['title'];
        ...
        //分页数组
        $nav = Db::table("dp_admin_navigation")->where(['pid'=>27])->order('sort')->field(['id','title'])->select();
    ...
    public function add()
    {
        ...
        //所属分页
        $list = Db::table("dp_admin_navigation")->where(['pid'=>27])->order('sort')->field(['id','title'])->select();
